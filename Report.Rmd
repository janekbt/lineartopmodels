...
* When looking only at theMean RMSE, we observe it was reduced by almost 20.000$. This, in terms of usefulness as a prediction tool in real life scenarios, is very desirable, given that it provides the end user with a more accurate estimation o the actual values.

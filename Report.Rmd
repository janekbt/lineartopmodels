...
For the following experiment (model 3), we will still keep the untransformed data, along with the new columns.
...
* In terms of our comparison criteria, introducing these 3 new variables improves the model.
* The Mean RMSE is reduced by more than 25.000$
* The standard deviation of RMSEs remains similar to the previous one. So adding these variables does not destabilizes the model cosiderably.
* Once Again, the P-value obtained suggests that the difference in the distribution of RMSEs is highly significant when using this additional variables.
* Considerably large improvement in the AIC metric.

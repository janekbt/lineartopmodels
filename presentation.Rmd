...
Looking back into the NA coefficients of the old model:
...
**Model with sqm_above & sqm_basement:**

  - $R^2_{adj}$: `r round(s_lmo_AB$adj.r.squared, 4)`
  - $AIC$: `r round(AIC(lmo_AB), 4)`
  - $BIC$: `r round(BIC(lmo_AB), 4)`
  

**Model with sqm_living:**

  - $R^2_{adj}$: `r round(s_lmo_L$adj.r.squared, 4)`
  - $AIC$: `r round(AIC(lmo_L), 4)`
  - $BIC$: `r round(BIC(lmo_L), 4)`
